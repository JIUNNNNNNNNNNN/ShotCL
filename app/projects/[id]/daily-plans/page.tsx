            ...
            <Card key={plan.id}>
              ...
              <div className="mt-4 grid gap-2">
                <Link
                  ...
                  className="inline-flex min-h-11 items-center justify-center rounded-[3px] border border-field-primary bg-field-primary px-4 text-sm font-black text-white"
                >
                  열기
                </Link>
