...
export const CONTEXTUAL_GUIDES: Record<ContextualGuideId, ContextualGuideDefinition> = {
  ...
  "progress.status": {
    ...
    priority: 100,
    title: "컷 상태",
    description: "카드의 왼쪽 빈 영역을 누르면 OMIT, 오른쪽 빈 영역을 누르면 OK로 변경됩니다. 마우스 우클릭으로 컷을 편집할 수 있습니다.",
    compactDescription: "카드를 오른쪽으로 밀면 OK, 왼쪽으로 밀면 OMIT로 변경됩니다. 길게 누르면 순서를 바꿀 수 있습니다.",
