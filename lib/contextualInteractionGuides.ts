...
> = {
  ...
  "archive.interaction-diagram-person-move": {
    ...
    variants: {
      fine: {
        title: "오브젝트 위치 이동",
        description: "카메라와 인물은 아이콘의 어느 부분을 끌어도 위치를 옮길 수 있습니다. 공간은 벽 선을 끌어 전체 위치를 이동할 수 있습니다.",
        detail: "공간 안쪽은 이동 대상이 아니므로 안에 있는 인물과 카메라를 바로 선택할 수 있습니다. 일반 드래그는 무빙 경로를 만들지 않습니다.",
        demo: "object-drag"
      },
      coarse: {
        title: "오브젝트 위치 이동",
  ...
  "archive.interaction-diagram-camera-move": {
    ...
    variants: {
      fine: {
        ...
        detail: "카메라의 두 열린 선은 현재 화각입니다. 무빙 끝의 고스트 카메라는 원래 카메라 방향을 유지합니다. 고스트를 선택하고 화각 선을 끌면 경로나 원본 카메라와 별개로 최종 방향만 조절할 수 있습니다. 패닝은 카메라 주변 회전 화살표로 구분됩니다.",
        demo: "camera-pan"
      },
      coarse: {
        title: "카메라 무빙 · 패닝",
  ...
  "archive.interaction-diagram-rotate": {
    ...
    variants: {
      fine: {
        title: "방향 · 화각 선 조절",
        description: "선택한 인물은 회전 컨트롤 포인트를 끌고, 카메라는 두 화각 선 중 어느 부분이든 끌어 바라보는 방향을 조절할 수 있습니다.",
        detail: "카메라 몸체는 위치 이동, 화각 선은 방향 조절에 사용합니다. 카메라 본체를 끌면 위치만 이동하고 화각 선을 끌면 카메라 중심을 기준으로 방향만 바뀝니다.",
        demo: "drag"
      },
      coarse: {
        title: "방향 · 화각 선 조절",
        description: "선택한 인물은 회전 컨트롤 포인트를 끌고, 카메라는 두 화각 선 중 어느 부분이든 손가락으로 끌어 바라보는 방향을 조절할 수 있습니다.",
        detail: "카메라 몸체는 위치 이동, 화각 선은 방향 조절에 사용합니다. 카메라 본체를 끌면 위치만 이동하고 화각 선을 끌면 카메라 중심을 기준으로 방향만 바뀝니다.",
        demo: "drag"
      }
    }
  ...
  "archive.interaction-diagram-room": {
    ...
    variants: {
      fine: {
        title: "열린 벽 · 닫힌 공간",
        description: "공간 도구로 점을 이어 벽을 만듭니다. 시작점에 연결하면 닫힌 공간이 되고, 그리다가 우클릭하면 열린 벽 형태 그대로 완성됩니다.",
        detail: "공간은 벽 선을 끌어 전체 위치를 이동하고 모서리 컨트롤 포인트를 끌어 형태를 조정합니다. 투명한 안쪽은 인물과 카메라 선택을 방해하지 않습니다. 같은 공간을 반복해서 그릴 필요가 없습니다. 씬리스트의 소장소를 기준으로 공간을 프리셋으로 저장하면 같은 장소의 새 부감도에 공간이 자동 적용됩니다.",
        demo: "tap"
      },
      coarse: {
        title: "열린 벽 · 닫힌 공간",
        description: "공간 도구로 점을 이어 벽을 만듭니다. 시작점에 연결하면 닫힌 공간이 되고, 그리다가 열린 벽 완료를 누르면 그 형태 그대로 완성됩니다.",
        detail: "공간은 벽 선을 끌어 전체 위치를 이동하고 모서리 컨트롤 포인트를 끌어 형태를 조정합니다. 투명한 안쪽은 인물과 카메라 선택을 방해하지 않습니다. 같은 공간을 반복해서 그릴 필요가 없습니다. 씬리스트의 소장소를 기준으로 공간을 프리셋으로 저장하면 같은 장소의 새 부감도에 공간이 자동 적용됩니다.",
        demo: "tap"
      }
    }
  ...
  "archive.interaction-diagram-path": {
    ...
    variants: {
      fine: {
        ...
        detail: "무빙을 만들어도 원본 오브젝트 위치는 그대로이며 목적지에는 연한 고스트가 표시됩니다. 카메라 고스트의 방향은 이동 경로와 별도로 편집합니다.",
  ...
  "archive.interaction-diagram-curve": {
    ...
    variants: {
      fine: {
        ...
        detail: "무빙 끝점을 옮기면 고스트 위치만 함께 이동합니다. 카메라 고스트의 최종 방향은 경로와 별도로 유지됩니다.",
        demo: "movement-curve"
      },
      coarse: {
        title: "곡선 무빙 편집",
