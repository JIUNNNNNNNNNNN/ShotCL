...
> = {
  ...
  "archive.interaction-diagram-person-move": {
    ...
    variants: {
      fine: {
        title: "오브젝트 위치 이동",
        description: "인물·카메라 본체를 끌어 위치를 옮기고, 공간은 벽 선을 끌어 전체 위치를 이동할 수 있습니다.",
  ...
  "archive.interaction-diagram-rotate": {
    ...
    variants: {
      fine: {
        ...
        detail: "카메라 본체를 끌면 위치만 이동하고 화각 선을 끌면 카메라 중심을 기준으로 방향만 바뀝니다.",
        demo: "drag"
      },
      coarse: {
        title: "방향 · 화각 선 조절",
  ...
  "archive.interaction-diagram-room": {
    ...
    variants: {
      fine: {
        ...
        detail: "공간은 벽 선을 끌어 전체 위치를 이동하고 모서리 컨트롤 포인트를 끌어 형태를 조정합니다. 투명한 안쪽은 인물과 카메라 선택을 방해하지 않습니다.",
        demo: "tap"
      },
      coarse: {
        title: "열린 벽 · 닫힌 공간",
