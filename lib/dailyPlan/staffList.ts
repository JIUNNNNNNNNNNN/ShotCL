...
const departmentColorPalette = [
  ...
  { background: "#eef3fa", border: "#6f86ad" },
  ...
  { background: "#edf5f8", border: "#6a91a8" },
  { background: "#f8f0f5", border: "#a46e89" },
  { background: "#eef6f3", border: "#4f9179" },
  { background: "#eef2f8", border: "#667fa4" },
  ...
  { background: "#edf5f6", border: "#5f8e9a" },
  { background: "#f4f0f8", border: "#8a72a3" },
