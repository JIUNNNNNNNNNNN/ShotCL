/** 날씨 기준 지역 선택에 사용하는 대한민국 광역/기초 행정구역 목록입니다. */
export const koreanWeatherRegions: Record<string, string[]> = {
...
export const koreanWeatherProvinces = Object.keys(koreanWeatherRegions);
