  ...
  function ArchiveDeleteDropZone({ isActive }, ref) {
    return (
      ...
      >
        <div
          ref={ref}
          className={`flex min-h-16 w-full items-center justify-center gap-2 rounded-[var(--radius-card)] border-2 px-4 py-3 font-semibold transition-[transform,border-color,background-color,color] duration-[var(--motion-fast)] motion-reduce:transition-none ${
          isActive
