...
function SideActionButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-10 w-full items-center gap-2 border border-field-divider bg-transparent px-3 py-2 text-left text-sm font-black text-field-text transition hover:border-field-subtle hover:bg-field-input active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-field-primary"
    >
      <Icon className="h-4 w-4 shrink-0" aria-hidden />
      {children}
    </button>
